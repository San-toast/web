...
const theFunction = () => {
  ...
  movieInfo.innerText = gg.Rated + "/" + gg.Runtime + "/" + gg.Genre;
  moviePlot.innerText = gg.Plot;
  moviePoster.src = gg.Poster;
  movieTitle.innerText = gg.Title;

  movieYear.innerText = gg.Year;
  container.append(movieTitle, moviePoster, movieYear);
};
theFunction();
